...
class PrettyPrinter {
 public:
  PrettyPrinter(int indent, int indent_size, int window, bool skip_new_lines, std::ostream* sink)
      : indent_(indent), indent_size_(indent_size), window_(window),
        skip_new_lines_(skip_new_lines), sink_(sink) {}
...
class SchemaPrinter : public PrettyPrinter {
 public:
  SchemaPrinter(const Schema& schema, int indent, int indent_size, int window,
      ...
      : PrettyPrinter(indent, indent_size, window, skip_new_lines, sink), schema_(schema) {}
